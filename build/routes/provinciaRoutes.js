...
const provincias_1 = require("../model/provincias");
...
class ProvinciasRoutes {
    constructor() {
        this.post = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const query = (yield provincias_1.Provincias.findOne({}, { id: 1, _id: 0 }).sort({ id: -1 }).limit(1));
            let newId;
            if (query == null) {
                newId = 0;
            }
            ...
            const oSchema = new provincias_1.Provincias(dSchema);
            yield oSchema.save()
                .then((doc) => {
        ...
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.db.conectarBD();
            yield provincias_1.Provincias.findOneAndDelete({ id: id })
                .then((doc) => {
                console.log(doc);
            });
        ...
        this.get = (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield database_1.db.conectarBD()
                ...
                const query = yield provincias_1.Provincias.find();
        ...
        this.getId = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.db.conectarBD();
            yield provincias_1.Provincias.findOne({ id: id })
                .then((docu) => {
                if (docu == null) {
        ...
        this.put = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const { comunidad, nombre, habitantes } = req.body;
            yield database_1.db.conectarBD();
            yield provincias_1.Provincias.findOneAndUpdate({ id: id }, {
                comunidad: comunidad,
                nombre: nombre,
                habitantes: habitantes,
            }, {
...
obj.misRutas();
exports.provinciasRoutes = obj.router;
